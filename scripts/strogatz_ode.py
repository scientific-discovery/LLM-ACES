...
For some systems that exhibit wildly different behavior for different parameter settings, we include multiple sets of parameter values as separate equations (e.g., Lorenz system in chaotic and non-chaotic regime).
...
Adapted from https://github.com/sdascoli/odeformer/blob/main/odeformer/odebench/strogatz_equations.py
"""
